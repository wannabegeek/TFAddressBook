...
#define CompareTFMultiValueIdentifiers(a, b) ([a isEqualToString:b])
...
#define TFAddressBook ABAddressBook
#define TFRecord ABRecord
#define TFPerson ABPerson
#define TFGroup ABGroup
#define TFMultiValue ABMultiValue
#define TFMutableMultiValue ABMutableMultiValue
#define TFSearchElement ABSearchElement
