...
@interface TFBasicSearchElement ()
@property (assign) NSUInteger searchComparison;
@property (assign) TFPropertyID property;
@property (strong) NSString *label;
@property (strong) NSString *key;
@property (strong) id value;
@property (assign) TFSearchComparison comparison;
...
- (NSString *)description {
	...
	[output appendString:[_predicate description]];
	return output;
}
